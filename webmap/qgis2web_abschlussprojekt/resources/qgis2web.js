...
// ---- Versteckte Layer manuell zur Karte hinzufügen ----
map.addLayer(lyr_Hintergrundbild_2);
map.addLayer(lyr_Dresden_3);
map.addLayer(lyr_Dresden_4);
map.addLayer(lyr_DresdnerHeide_10);
// --------------------------------------------------------

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1529705.707526, 6630686.299087, 1552920.659358, 6647557.741447], map.getSize());
